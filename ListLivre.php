...
if(isset($_SESSION["username"]))
{
    ...
    <nav>
        ...
        <li><a href='listlivre.php' class='navbar-brand'> <img src='images/logo2.png' style='height:80px;width:80px;margin-button: 200px;' ></a></li>
        <li><h4 style='margin-top:14px'>Livre Store</h4></li>
            ...
            <li style='margin-top:14px; margin-left:400px'>Bienvenue <b>$nom</b> </li>
